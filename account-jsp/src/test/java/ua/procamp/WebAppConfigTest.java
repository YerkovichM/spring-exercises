...
import ua.procamp.config.RootConfig;
import ua.procamp.config.WebConfig;
import ua.procamp.util.WebAppInitializerWrapper;
...
public class WebAppConfigTest {
    ...
    public void testRootConfigComponentScanPackages() {
        ...
        assertThat(componentScan.basePackages(), arrayContaining("ua.procamp"));
    }
    ...
    public void testWebConfigComponentScanPackages() {
        ...
        assertThat(componentScan.value(), arrayContaining("ua.procamp.web"));
    }
